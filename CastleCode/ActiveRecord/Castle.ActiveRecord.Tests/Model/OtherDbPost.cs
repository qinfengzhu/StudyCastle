...
namespace Castle.ActiveRecord.Tests
{
	...
	public class OtherDbPost : Test2ARBase
	{
		private int _id;
		...
		public static OtherDbPost[] FindAll()
		{
			return (OtherDbPost[]) ActiveRecordBase.FindAll( typeof(OtherDbPost) );
		}

		public static OtherDbPost Find(int id)
		{
			return (OtherDbPost) ActiveRecordBase.FindByPrimaryKey( typeof(OtherDbPost), id );
		}
