@SET VSINSTALLDIR=C:\dev\dotnet\VSNet2003\Common7\IDE
@SET VCINSTALLDIR=C:\dev\dotnet\VSNet2003
@SET FrameworkDir=C:\WINDOWS\Microsoft.NET\Framework
@SET FrameworkVersion=v1.1.4322
@SET FrameworkSDKDir=C:\dev\dotnet\VSNet2003\SDK\v1.1
...
:end
CassiniWebServer.exe "E:\dev\projects\digitalgravity\castle\trunk\Samples\PestControl\Castle.Applications.PestControl.Web" 8082 /
