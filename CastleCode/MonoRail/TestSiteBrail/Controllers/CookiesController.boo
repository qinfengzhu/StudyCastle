...
class CookiesController(Controller):
	...
	def AddCookieRedirect():
		Context.Response.CreateCookie("cookiename", "value")
		Redirect("cookies", "index")
	
	def AddCookieExpiration():
		twoWeeks = DateTime.Now.Add(TimeSpan(14,0,0,0))
		Context.Response.CreateCookie("cookiename2","value", twoWeeks)
		RenderView("Index")
	
	def AddCookieExpirationRedirect():
		twoWeeks = DateTime.Now.Add(TimeSpan(14,0,0,0))
		Context.Response.CreateCookie("cookiename2","value", twoWeeks)
		Redirect("cookies", "index")
